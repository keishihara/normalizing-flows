...
from nfs.flows import AffineHalfFlow
...
def main() -> None:
    ...
    # Save checkpoint
    torch.save(model.state_dict(), CKPT_DIR / f"rnvp_{args.dataset}_step{args.num_steps}.pth")
    ...
    plt.axis("equal")
    plt.tight_layout()
    plt.savefig(ASSETS_DIR / f"rnvp_{args.dataset}_step{args.num_steps}.png")
